...
func runServ(c *cli.Context) error {
	...
	if verb == gitAnnexShellVerb {
		_path, err := filepath.Abs(filepath.Join(setting.RepoRootPath, repoPath)) // git-annex-shell demands an absolute path
		if err != nil {
	...
	if _, err := os.Stat(gitBinVerb); err != nil {
		...
		// ps: git-annex-shell and other extensions may not necesarily be in gitBinPath,
