...
Furthermore, this particular fork was forked in 2022 to add [git-annex](https://git-annex.branchable.com/)
support, in parallel with the pre-existing git-lfs support.
This makes it similar to [GIN](https://gin.g-node.org/G-Node/Info/wiki/GIN+Advantages+Structure),
but based on the better-maintained and more featureful Gitea instead of Gogs.
